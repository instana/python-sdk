...
class ApplicationConfig(BaseModel):
    ...
    business_criticality: Optional[Annotated[int, Field(le=5, strict=True, ge=0)]] = Field(default=None, description="Business criticality of an application (0-5)", alias="businessCriticality")
