...
class ApiToken(BaseModel):
    ...
    can_configure_entity_payload_transformation_rules: Optional[StrictBool] = Field(default=None, alias="canConfigureEntityPayloadTransformationRules")
    ...
    can_playback_session_replay: Optional[StrictBool] = Field(default=None, alias="canPlaybackSessionReplay")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canPlaybackSessionReplay": obj.get("canPlaybackSessionReplay"),
